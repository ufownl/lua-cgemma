...
#### cgemma.compress_weights

**syntax:** `<boolean>ok, <string>err = cgemma.compress_weights(<string>model, <string>weights, <string>compressed_weights[, <cgemma.scheduler>sched])`
...
-----|-------------|---------
model | Model type: `"2b-pt"`, `"7b-pt"`, `"2b-it"`, `"7b-it"`. | Yes
